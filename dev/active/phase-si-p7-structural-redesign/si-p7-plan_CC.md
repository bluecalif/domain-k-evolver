...
**이번 phase 범위** (baseline v2 §권장 착수 순서):
...
3. **entity 유입 경로** (Step C) — concrete entity candidate 가 적재되고 승격되어 skeleton 등록 + 후속 GU 자동 오픈. β mode 가 stagnation 시 동작.
...
- **L3** (축 완료): `bench/silver/japan-travel/p7-<축>-on|off/` 15c A/B, **공식 Gate 판정**
...
- context: `si-p7-context_CC.md`
- tasks: `si-p7-tasks_CC.md`
- debug history: `si-p7-debug-history_CC.md`
