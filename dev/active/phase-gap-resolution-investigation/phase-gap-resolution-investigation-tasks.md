...
> Status: **Complete** — 12/12 (2026-04-14)
...
|-------|-------|------|
| A. 진단 로깅 + 정적 분석 | 3 | 3/3 ✅ |
| B. Primary Fix (cap 제거) | 3 | 3/3 ✅ (B1+B2 병합, B3 N/A) |
| C. 재현 Trial + 효과 검증 | 3 | 3/3 ✅ (Gate PASS, gap_res 0.99) |
| D. Secondary 대응 결정 | 3 | 3/3 ✅ (D-130 실체 없음) |
| **합계** | **12** | **12/12** |
...
- [x] **A1** [S] `src/nodes/collect.py` parse_yield 로깅
...
- [x] **A2** [S] `src/nodes/integrate.py` integration_result 분포 로깅
...
- [x] **A3** [M] 기존 15c trial 정적 분석 스크립트
...
- [x] **B1** [S] `src/nodes/mode.py` target_count cap 제거
...
- [x] **C1** [M] gap-res-fix-trial 생성 + 실행
...
- [x] **C2** [M] trajectory before/after 분석
